  ...
  return (
    <div className="cerber">
      ...
      <div className="txtBox">
        <p>
          Ai reușit să o ajuți pe Persefona să strângă rodiile, iar zeița a decis să
          te îndrume spre ieșirea din Infern, care este păzită de căinele
          credincios al lui Hades, Cerber. Cerber este câinele monstruos cu trei
          capete, pe spate are o mulțime de șerpi agresivi, iar coada lui este
          tot un șarpe. Acesta permite doar sufletelor morților să intre, dar
          mai ales veghează ca nimeni să nu mai iasă, împiedicându-le
